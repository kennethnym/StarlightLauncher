...
val PREF_KEY_USE_24HR_CLOCK = booleanPreferencesKey("date_time_use_24hr_clock")
val PREF_KEY_SHOW_WEATHER = booleanPreferencesKey("date_time_show_weather")
val PREF_KEY_CLOCK_SIZE = stringPreferencesKey("date_time_clock_size")
val PREF_KEY_USE_AUTO_LOCATION = booleanPreferencesKey("date_time_use_auto_location")
